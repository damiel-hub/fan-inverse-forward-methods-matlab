function [fitting_s_z, bin_pts_mid_s, Q2, ss_in, z_in, ss_up, z_up, ss_do, z_do, s_T, L, S, P, RMSE, dimensionless_drop, slope] = process_s_z_relationship_return_info(sMap, zMap, bin_size, ds, outlength, pltFlag, options)
